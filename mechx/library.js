...
(function () {
  ...
  var LIBRARY = {
    ...
    "balance-scale": {
      fig: "active.jpg",
      figName: "Scale",
      cap: "Компонент «Scale» (весы), 332×192px, со спек-борда «Типы механик»: коромысло, две чаши, активная подсвечена. Отдельного полноэкранного макета нет.",
      vers: [],
