...
const CASES = [
  { tag: "t-age", tagText: "Возраст · фидбек", title: "Перебор не виден до проверки", Demo: LiveColorDemo,
  ...
  { tag: "t-touch", tagText: "Планшет · касание", title: "Убрать монету только кнопкой «−»", Demo: RemoveDemo,
