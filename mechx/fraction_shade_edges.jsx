    ...
    <React.Fragment>
      <div className="ec-controls">
        <div className="seg">
          ...
          <button className={fix ? "on" : ""} onClick={() => setFix(true)}>вариант: счётчик (не берём)</button>
        </div>
      </div>
      ...
      <div className="demo-note">{fix
        ? "Так выглядел бы живой счётчик «N / 6». Решили не добавлять: суть в связи секторов и дроби, а не в подсчёте."
...
const CASES = [
  { tag: "t-age", tagText: "Возраст · фидбек", title: "Живой счётчик дроби: не делаем", Demo: CounterDemo,
  ...
  { tag: "t-grade", tagText: "Задание · проверка", title: "«Закрась ноль» нельзя подтвердить: не делаем (0 не используем)", Demo: ZeroDemo,
