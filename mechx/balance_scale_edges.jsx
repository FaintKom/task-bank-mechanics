    ...
    <React.Fragment>
      <div className="ec-controls">
        <div className="seg">
          ...
          <button className={fix ? "on" : ""} onClick={() => setFix(true)}>режим подсказки: разница числом</button>
        </div>
      ...
      <div className="demo-note">{fix
        ? "Режим подсказки: подпись «перевес +N г / не хватает N г» прямо показывает, насколько и в какую сторону промах. Это включаемый флаг, по умолчанию выключен."
...
const CASES = [
  ...
  { tag: "t-age", tagText: "Возраст · фидбек", title: "Малый наклон: добавляем режим подсказки с числовой разницей (флаг, по умолчанию выкл)", Demo: TiltDemo,
