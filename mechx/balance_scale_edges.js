...
function TiltDemo() {
  ...
  return /*#__PURE__*/React.createElement(React.Fragment, null, /*#__PURE__*/React.createElement("div", {
    ...
    className: fix ? "on" : "",
    onClick: () => setFix(true)
  }, "\u0440\u0435\u0436\u0438\u043C \u043F\u043E\u0434\u0441\u043A\u0430\u0437\u043A\u0438: \u0440\u0430\u0437\u043D\u0438\u0446\u0430 \u0447\u0438\u0441\u043B\u043E\u043C")), /*#__PURE__*/React.createElement("span", {
    className: "mech-label",
    style: {
      fontSize: 13
    }
    ...
    className: "demo-note"
  }, fix ? "Режим подсказки: подпись «перевес +N г / не хватает N г» прямо показывает, насколько и в какую сторону промах. Это включаемый флаг, по умолчанию выключен." : "Наклон коромысла ограничен и при «почти равновесии» едва заметен: ребёнок не понимает, перебрал он на 1 г или на 5 г."));
}
...
const CASES = [{
  ...
  title: "Малый наклон: добавляем режим подсказки с числовой разницей (флаг, по умолчанию выкл)",
  Demo: TiltDemo,
  ...
  fix: "Решение: делаем как режим подсказки (Julia: «давайте как режим подсказки»). Флаг showDifference показывает числовую разницу «перевес +N г / не хватает N г»; по умолчанию выключен, чтобы по базовому заданию ребёнок сам разбирался с наклоном (позиция Maksim)."
}];
function Cases() {
