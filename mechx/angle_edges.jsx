...
const CASES = [
  { tag: "t-tab", tagText: "Планшет · эргономика", title: "Отметки градусов меньше 44px", Demo: HitAreaDemo,
    ...
    fix: "Доработать: увеличить зоны нажатия до ≥44px, для мелкого шага сделать крупнее транспортир или ввод через перетаскивание луча. Как и с линейкой, методисту нужно дать возможность задавать масштаб транспортира под конкретную задачу." },
