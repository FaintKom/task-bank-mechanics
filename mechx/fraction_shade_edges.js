...
function CounterDemo() {
  ...
  return /*#__PURE__*/React.createElement(React.Fragment, null, /*#__PURE__*/React.createElement("div", {
    ...
    className: fix ? "on" : "",
    onClick: () => setFix(true)
  }, "\u0432\u0430\u0440\u0438\u0430\u043D\u0442: \u0441\u0447\u0451\u0442\u0447\u0438\u043A (\u043D\u0435 \u0431\u0435\u0440\u0451\u043C)"))), /*#__PURE__*/React.createElement(TabletFrame, null, /*#__PURE__*/React.createElement(FractionShade, {
    key: fix ? "f" : "n",
    denominator: 6,
    targetFilled: 4,
    liveCounter: fix
    ...
    className: "demo-note"
  }, fix ? "Так выглядел бы живой счётчик «N / 6». Решили не добавлять: суть в связи секторов и дроби, а не в подсчёте." : "Счётчик появляется только после «Проверить». По ходу ребёнок не видит, сколько частей уже закрасил, и приходится считать сектора глазами."));
}
...
const CASES = [{
  ...
  title: "Живой счётчик дроби: не делаем",
  Demo: CounterDemo,
  ...
  fix: "Решение: не делаем (Julia). Суть задания в понимании связи между секторами на рисунке и дробью, счётчик подменял бы это готовым числом. Число секторов держим небольшим через методиста, чтобы считать было удобно и без счётчика."
}, {
  tag: "t-tab",
  ...
  title: "«Закрась ноль» нельзя подтвердить: не делаем (0 не используем)",
  Demo: ZeroDemo,
  ...
  fix: "Решение: не делаем (Julia). Задания с нулевым ответом (target_filled = 0) для этой механики не используем, поэтому подтверждать пустой ответ не нужно."
}];
function Cases() {
  return /*#__PURE__*/React.createElement(React.Fragment, null, CASES.map((c, i) => {
    ...
    return /*#__PURE__*/React.createElement("article", {
      ...
      className: "fix"
    }, /*#__PURE__*/React.createElement("b", null, "\u041A\u0430\u043A \u0447\u0438\u043D\u0438\u0442\u044C:"), " ", c.fix)), D && /*#__PURE__*/React.createElement(D, null));
  }));
}
