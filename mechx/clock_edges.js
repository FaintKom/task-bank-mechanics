...
function Clock({
  ...
  const needHour = mode !== "minute",
    needMinute = mode !== "hour";
  ...
  return /*#__PURE__*/React.createElement("div", {
  ...
  }, promptText), /*#__PURE__*/React.createElement("svg", {
    viewBox: "0 0 260 260",
    style: {
      width: "100%",
      maxWidth: 280,
    ...
    const [x1, y1] = at(m / 60, 103);
    const [x2, y2] = at(m / 60, 108);
  ...
  }), needMinute && mn && /*#__PURE__*/React.createElement("line", {
    x1: C,
    y1: C,
    x2: mn[0],
    y2: mn[1],
    ...
    strokeWidth: 4,
    strokeLinecap: "round"
  }), needHour && hr && /*#__PURE__*/React.createElement("line", {
    x1: C,
    y1: C,
    x2: hr[0],
    y2: hr[1],
  ...
  }), needMinute && MINUTES.map(m => {
    const [x, y] = at(m / 60, 112);
  ...
  })), (liveReadout || graded) && ready && /*#__PURE__*/React.createElement("span", {
    className: "mech-readout",
    style: {
      color: graded ? accent : "var(--sel-fg)"
    }
  }, mode === "minute" ? `:${pad(v.minute)}` : mode === "hour" ? `${v.hour}:__` : `${v.hour}:${pad(v.minute)}`), /*#__PURE__*/React.createElement("button", {
    type: "button",
...
/* ── рабочий пример ── */
function Example() {
  return /*#__PURE__*/React.createElement(TabletFrame, null, /*#__PURE__*/React.createElement(Clock, {
    targetHour: 3,
    targetMinute: 0
  }));
}
...
function HitAreaDemo() {
  ...
  return /*#__PURE__*/React.createElement(React.Fragment, null, /*#__PURE__*/React.createElement("div", {
    ...
    className: "demo-note"
  }, fix ? "Зоны минутных точек и часов увеличены до норматива, попасть в нужную отметку легко." : "Минутные точки и часовые зоны меньше 44px и стоят близко у центра и обода, поэтому на планшете палец 9-летнего часто попадает в соседнюю отметку."));
}
...
function ReadoutDemo() {
  ...
  return /*#__PURE__*/React.createElement(React.Fragment, null, /*#__PURE__*/React.createElement("div", {
    ...
    className: "demo-note"
  }, fix ? "Цифровое «7:15» обновляется по мере выставления стрелок, ребёнок сверяет своё время с заданным до проверки." : "Цифровое табло появляется только после «Проверить». По ходу ребёнок не видит, какое время выставил стрелками."));
}
...
function SingleHandDemo() {
  ...
  return /*#__PURE__*/React.createElement(React.Fragment, null, /*#__PURE__*/React.createElement("div", {
    ...
    className: mode === "minute" ? "on" : "",
    onClick: () => setMode("minute")
  }, "\u0422\u043E\u043B\u044C\u043A\u043E \u043C\u0438\u043D\u0443\u0442\u043D\u0430\u044F"), /*#__PURE__*/React.createElement("button", {
    className: mode === "hour" ? "on" : "",
    onClick: () => setMode("hour")
  }, "\u0422\u043E\u043B\u044C\u043A\u043E \u0447\u0430\u0441\u043E\u0432\u0430\u044F"), /*#__PURE__*/React.createElement("button", {
    className: mode === "both" ? "on" : "",
    onClick: () => setMode("both")
  }, "\u041E\u0431\u0435"))), /*#__PURE__*/React.createElement(TabletFrame, null, /*#__PURE__*/React.createElement(Clock, {
    key: mode,
    targetHour: 9,
    targetMinute: 35,
    hitR: 22,
    ...
    className: "demo-note"
  }, mode === "both" ? "Сейчас механика всегда требует обе стрелки сразу." : `Запрос методиста: режим «${mode === "minute" ? "только минутная" : "только часовая"}», тренировать одну стрелку отдельно, не выставляя вторую.`));
}
...
function DragClock({
  ...
  const hr = at(v.hour % 12 / 12 + v.minute / 720, 58);
  const mn = at(v.minute / 60, 92);
  return /*#__PURE__*/React.createElement("div", {
    className: "mech"
  }, /*#__PURE__*/React.createElement("div", {
    className: "mech-stack",
  ...
  }, "\u041F\u043E\u043A\u0430\u0436\u0438 \u0432\u0440\u0435\u043C\u044F ", targetHour, ":", pad(targetMinute)), /*#__PURE__*/React.createElement("svg", {
    ref: svgRef,
    viewBox: "0 0 260 260",
    style: {
      width: "100%",
    ...
    strokeWidth: 6,
    strokeLinecap: "round"
  }), !graded && /*#__PURE__*/React.createElement("circle", {
    cx: mn[0],
    cy: mn[1],
    r: 20,
    fill: "var(--sel-accent)",
    opacity: drag === "minute" ? 0.5 : 0.22,
    ...
    cy: hr[1],
    r: 22,
    fill: "var(--grape, #845ef7)",
    opacity: drag === "hour" ? 0.5 : 0.22,
    stroke: "var(--sel-accent)",
    strokeWidth: 2,
    style: {
      cursor: "grab"
  ...
  }, v.hour, ":", pad(v.minute)), /*#__PURE__*/React.createElement("button", {
    type: "button",
    className: "mech-check",
    disabled: graded,
    onClick: () => setGraded(true),
...
function RotateHandsDemo() {
  ...
  return /*#__PURE__*/React.createElement(React.Fragment, null, /*#__PURE__*/React.createElement("div", {
    ...
    className: mode === "tap" ? "on" : "",
    onClick: () => setMode("tap")
  }, "\u041A\u0430\u043A \u0435\u0441\u0442\u044C (\u0442\u0430\u043F)"), /*#__PURE__*/React.createElement("button", {
    className: mode === "drag" ? "on" : "",
    onClick: () => setMode("drag")
  }, "\u041A\u0440\u0443\u0442\u0438\u0442\u044C (\u0448\u0430\u0433 5)"), /*#__PURE__*/React.createElement("button", {
    className: mode === "precise" ? "on" : "",
    onClick: () => setMode("precise")
  }, "\u041A\u0440\u0443\u0442\u0438\u0442\u044C \u043F\u043E\u043C\u0438\u043D\u0443\u0442\u043D\u043E"))), mode === "tap" ? /*#__PURE__*/React.createElement(TabletFrame, null, /*#__PURE__*/React.createElement(Clock, {
    targetHour: 3,
    targetMinute: 40,
    hitR: 22,
    liveReadout: true
  })) : /*#__PURE__*/React.createElement(TabletFrame, null, /*#__PURE__*/React.createElement(DragClock, {
    key: mode,
    targetHour: 3,
    targetMinute: mode === "precise" ? 37 : 40,
    minuteStep: mode === "precise" ? 1 : 5
  })), /*#__PURE__*/React.createElement("div", {
    className: "demo-note"
  }, mode === "tap" ? "Сейчас стрелки выставляются только тапом по нужной отметке, покрутить стрелку, как на настоящих часах, нельзя." : mode === "drag" ? "Схвати цветной кончик стрелки и крути вокруг центра: стрелка следует за пальцем и встаёт на ближайшую отметку (час или 5 минут)." : "Поминутный режим: минутная стрелка снапится к каждой минуте (цель 3:37), можно выставлять точное время, не кратное 5."));
}
const CASES = [{
  tag: "t-touch",
  tagText: "Планшет · касание",
  title: "Стрелки нельзя крутить, только тап",
  Demo: RotateHandsDemo,
  ...
  title: "Тап-зоны стрелок меньше 44px",
  Demo: HitAreaDemo,
  ...
  title: "Нет живого табло времени",
  Demo: ReadoutDemo,
  ...
  fix: "Доработать: показывать живое цифровое время по мере выставления стрелок, это и опора чтения часов, и самопроверка. Сделать это настройкой, по умолчанию выключенной, чтобы не подсказывать ответ там, где цель именно прочитать часы."
}, {
  tag: "t-cfg",
  tagText: "Задание · охват",
  title: "Нельзя тренировать одну стрелку",
  Demo: SingleHandDemo,
