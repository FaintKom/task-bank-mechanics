...
function NumberLine({
  ...
  const ticks = [];
  if (step > 0 && from < to) {
    for (let v = from; v <= to + 1e-9 && ticks.length <= 61; v += step) ticks.push(round(v));
  }
  ...
  return /*#__PURE__*/React.createElement("div", {
  ...
  }, "\u041E\u0442\u043C\u0435\u0442\u044C \u0447\u0438\u0441\u043B\u043E ", target, unit ? ` ${unit}` : ""), readout && value != null && /*#__PURE__*/React.createElement("p", {
    className: "mech-readout",
    style: {
      margin: 0,
      color: "var(--sel-fg)"
    }
  }, "\u0412\u044B \u043E\u0442\u043C\u0435\u0442\u0438\u043B\u0438: ", value, unit ? ` ${unit}` : ""), invalid ? /*#__PURE__*/React.createElement("div", {
    style: {
      width: "100%",
      maxWidth: 760,
      height: 150,
  ...
  }, "\u2014  (\u0434\u0435\u043B\u0435\u043D\u0438\u0439 ", ticks.length > 60 ? ">60" : "<2", ", \u043E\u0441\u044C \u043D\u0435 \u043F\u043E\u0441\u0442\u0440\u043E\u0435\u043D\u0430)")) : /*#__PURE__*/React.createElement("div", {
    style: {
      position: "relative",
      width: "100%",
      maxWidth: 820
    ...
    stroke: "var(--line)",
    strokeWidth: 4
  }), i % labelEvery === 0 && /*#__PURE__*/React.createElement("text", {
    x: x(t),
    y: Y + 46,
    textAnchor: "middle",
    fontSize: 26,
  ...
  }, t, unit ? ` ${unit}` : ""))), graded && /*#__PURE__*/React.createElement("circle", {
    cx: x(target),
    cy: Y,
    r: 17,
    fill: "none",
    ...
    r: 13,
    fill: markerColor
  }), fingerAt != null && /*#__PURE__*/React.createElement("circle", {
    cx: x(fingerAt),
    cy: Y,
    r: 22,
    fill: "rgba(62,145,214,.26)",
    stroke: "var(--sel-accent)",
    strokeWidth: 3
  }), queryAt != null && /*#__PURE__*/React.createElement("g", null, /*#__PURE__*/React.createElement("text", {
    x: x(queryAt),
    y: Y - 24,
    textAnchor: "middle",
    fontSize: 32,
    fontWeight: 800,
    fill: "var(--no-accent)"
  }, "?")), handAt != null && /*#__PURE__*/React.createElement("g", {
    fill: "#e7b08b",
    stroke: "#c98f66",
    strokeWidth: 3,
    strokeLinejoin: "round",
    style: {
      filter: "drop-shadow(-4px 4px 7px rgba(0,0,0,.28))"
    }
    ...
    disabled: value == null || graded || invalid,
...
/* ── рабочий пример ── */
function Example() {
  return /*#__PURE__*/React.createElement(TabletFrame, null, /*#__PURE__*/React.createElement(NumberLine, {
    config: {
      from: 0,
      to: 10,
      step: 1,
...
function DragAxis({
  ...
  const ref = useRef(null);
  const ticks = [];
  for (let v = from; v <= to + 1e-9; v += step) ticks.push(round(v));
  const W = 1000,
    PAD = 60,
    Y = 70;
  const xf = v => (PAD + (v - from) / (to - from) * (W - 2 * PAD)) / W;
  const valFrom = f => {
    const raw = from + (f - PAD / W) / ((W - 2 * PAD) / W) * (to - from);
    const s = Math.round((raw - from) / step) * step + from;
    return Math.max(from, Math.min(to, round(s)));
  };
  const upd = e => {
  ...
  return /*#__PURE__*/React.createElement("div", {
  ...
  }, "\u041E\u0442\u043C\u0435\u0442\u044C \u0447\u0438\u0441\u043B\u043E ", target), val != null && /*#__PURE__*/React.createElement("p", {
    className: "mech-readout",
    style: {
      margin: 0,
      color: "var(--sel-fg)"
    }
  }, "\u0412\u044B \u043E\u0442\u043C\u0435\u0442\u0438\u043B\u0438: ", val), /*#__PURE__*/React.createElement("div", {
    ref: ref,
    onPointerDown: e => {
    ...
    fontWeight: 700,
    fill: "var(--ink)"
  }, t))), val != null && /*#__PURE__*/React.createElement("circle", {
    cx: xf(val) * W,
    cy: Y,
    r: 13,
    fill: "var(--sel-accent)"
  ...
  }, "\u0442\u044F\u043D\u0438 \u0432 \u043B\u044E\u0431\u043E\u043C \u043C\u0435\u0441\u0442\u0435, \u043F\u0430\u043B\u0435\u0446 \u043D\u0435 \u0437\u0430\u043A\u0440\u044B\u0432\u0430\u0435\u0442 \u0447\u0438\u0441\u043B\u043E"), val != null && /*#__PURE__*/React.createElement("div", {
    style: {
      position: "absolute",
      left: `${xf(val) * 100}%`,
      top: 0,
    ...
    style: {
      ...
      borderRadius: "50%",
      background: "#fff",
      border: "4px solid var(--sel-accent)",
  ...
  }, round(val - step), " \xB7 ", val, " \xB7 ", round(val + step))), /*#__PURE__*/React.createElement("div", {
    style: {
      width: 0,
      height: 0,
      borderLeft: "9px solid transparent",
      borderRight: "9px solid transparent",
      borderTop: "13px solid var(--sel-accent)",
      margin: "0 auto"
    }
  })), down && pt && /*#__PURE__*/React.createElement("div", {
    style: {
      position: "absolute",
      left: pt.x,
      top: pt.y,
  ...
  }, /*#__PURE__*/React.createElement(FingerTipSkin, null)))));
}
...
function FingerConfirmDemo() {
  ...
  return /*#__PURE__*/React.createElement(React.Fragment, null, /*#__PURE__*/React.createElement("div", {
    ...
    step: 1,
    target: 7
  })) : /*#__PURE__*/React.createElement(TabletFrame, null, /*#__PURE__*/React.createElement(NumberLine, {
    config: {
      from: 0,
      to: 10,
      step: 1,
    ...
    className: "demo-note"
  }, fix ? "Тянешь палец по горизонтали в любом месте (в стороне от прямой), над точкой видна лупа с увеличенным числом, плюс крупное «Вы отметили: N». Палец не закрывает деление." : "Палец закрыл деление 7: в момент тапа не видно ни деления, ни метки, и нигде не написано, какое число выбрано."));
}
...
function DenseDemo() {
  ...
  return /*#__PURE__*/React.createElement(React.Fragment, null, /*#__PURE__*/React.createElement("div", {
  ...
  }, "\u0428\u0430\u0433 1 (0\u202630)"), /*#__PURE__*/React.createElement("button", {
    className: !dense ? "on" : "",
    onClick: () => setDense(false)
  }, "\u0428\u0430\u0433 5 (0\u202630)"))), /*#__PURE__*/React.createElement(TabletFrame, null, /*#__PURE__*/React.createElement(NumberLine, {
    key: dense ? "d" : "s",
    config: {
      from: 0,
      to: 30,
    ...
    fingerAt: dense ? 15 : undefined
  })), /*#__PURE__*/React.createElement("div", {
    className: "demo-note"
  }, dense ? "31 деление: подушечка пальца (синий круг ≈44px) накрывает сразу 14, 15 и 16, точно попасть невозможно." : "При шаге 5 деления далеко друг от друга, попасть легко."));
}
...
function UnlabeledDemo() {
  return /*#__PURE__*/React.createElement(React.Fragment, null, /*#__PURE__*/React.createElement("div", {
  ...
  }, "\u0426\u0435\u043B\u044C \u044D\u0442\u043E 13")), /*#__PURE__*/React.createElement(TabletFrame, null, /*#__PURE__*/React.createElement(NumberLine, {
    config: {
      from: 0,
      to: 20,
      step: 1,
    ...
    className: "demo-note"
  }, "\u041F\u043E\u0434\u043F\u0438\u0441\u0430\u043D\u044B \u0442\u043E\u043B\u044C\u043A\u043E \u0447\u0451\u0442\u043D\u044B\u0435 (0, 2, \u2026 20). \u0426\u0435\u043B\u044C 13 \u0441\u0442\u043E\u0438\u0442 \u043D\u0430 \u043D\u0435\u043F\u043E\u0434\u043F\u0438\u0441\u0430\u043D\u043D\u043E\u043C \u0448\u0442\u0440\u0438\u0445\u0435: \u0440\u0435\u0431\u0451\u043D\u043E\u043A \u0441\u0447\u0438\u0442\u0430\u0435\u0442 \u0448\u0442\u0440\u0438\u0445\u0438 \u043E\u0442 12, \u043B\u0435\u0433\u043A\u043E \u0441\u0431\u0438\u0442\u044C\u0441\u044F, \u0438 \u0432\u044B\u0431\u0440\u0430\u043D\u043D\u043E\u0435 \u0437\u043D\u0430\u0447\u0435\u043D\u0438\u0435 \u043D\u0438\u0433\u0434\u0435 \u043D\u0435 \u043F\u043E\u0434\u0442\u0432\u0435\u0440\u0436\u0434\u0430\u0435\u0442\u0441\u044F."));
}
...
function BigNumbersDemo() {
  ...
  return /*#__PURE__*/React.createElement(React.Fragment, null, /*#__PURE__*/React.createElement("div", {
    ...
    className: mode === "fine" ? "on" : "",
    onClick: () => setMode("fine")
  }, "\u0428\u0430\u0433 10 000"), /*#__PURE__*/React.createElement("button", {
    className: mode === "coarse" ? "on" : "",
    onClick: () => setMode("coarse")
  }, "\u0428\u0430\u0433 100 000"))), /*#__PURE__*/React.createElement(TabletFrame, null, /*#__PURE__*/React.createElement(NumberLine, {
    key: mode,
    config: cfg
  })), /*#__PURE__*/React.createElement("div", {
    className: "demo-note"
  }, mode === "fine" ? "Числа до 1 000 000 при шаге 10 000 дают 100 делений, больше лимита 60: ось вообще не строится («—»)." : "При шаге 100 000 делений 11, но подписи (100000…1000000) длинные и налезают друг на друга."));
}
const CASES = [{
  tag: "t-touch",
  tagText: "Планшет · касание",
  title: "Палец закрывает деление, нет подтверждения",
  Demo: FingerConfirmDemo,
  ...
  title: "Плотные деления, палец накрывает соседние",
  Demo: DenseDemo,
  ...
  tag: "t-age",
  tagText: "Возраст · чтение шкалы",
  title: "Неподписанные деления и счёт штрихов",
  Demo: UnlabeledDemo,
  ...
  title: "Большие числа: либо пусто, либо подписи налезают",
  Demo: BigNumbersDemo,
