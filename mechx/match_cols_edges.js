...
function rightOptions(config) {
  const seen = new Set();
  const out = [];
  for (const p of config.pairs) if (!seen.has(p.right)) {
    seen.add(p.right);
    out.push(p.right);
  }
  return out;
...
function shuffledOrder(n) {
  const shift = n >= 2 ? Math.max(1, Math.floor(n / 2)) : 0;
  return Array.from({
    length: n
  }, (_, i) => (i + shift) % n);
}
...
function MatchColumns({
  ...
  const measure = () => {
    ...
    for (const [l, r] of Object.entries(matches)) {
      const lt = leftRefs.current[l],
        rt = rightRefs.current[r];
      if (!lt || !rt) continue;
      const a = offsetWithin(lt, root),
        b = offsetWithin(rt, root);
      next.push({
        left: Number(l),
        x1: a.x + lt.offsetWidth,
        y1: a.y + lt.offsetHeight / 2,
        x2: b.x,
        y2: b.y + rt.offsetHeight / 2
      });
    }
    setLines(next);
  };
  ...
  const rightToLefts = {};
  for (const [l, r] of Object.entries(matches)) (rightToLefts[r] ??= []).push(Number(l));
  ...
  return /*#__PURE__*/React.createElement("div", {
  ...
  }, "\u0421\u043E\u0435\u0434\u0438\u043D\u0438 \u043F\u0440\u0438\u043C\u0435\u0440 \u0441 \u043E\u0442\u0432\u0435\u0442\u043E\u043C"), /*#__PURE__*/React.createElement("div", {
    ref: rootRef,
    className: "mech-match",
    style: {
      position: "relative",
      width: "100%",
      maxWidth: 560
  ...
  }, lines.map(ln => /*#__PURE__*/React.createElement("line", {
    key: ln.left,
    x1: ln.x1,
    y1: ln.y1,
    x2: ln.x2,
    y2: ln.y2,
    stroke: stroke(ln.left),
    strokeWidth: 4,
    strokeLinecap: "round"
  }))), /*#__PURE__*/React.createElement("div", {
    className: "mech-col"
  }, config.pairs.map((pair, i) => {
    const isActive = active?.side === "left" && active.index === i;
    ...
    return /*#__PURE__*/React.createElement("button", {
      ...
      className: "mech-tile",
      onClick: () => tapTile("left", i),
      disabled: graded,
      "data-selected": !graded && (isActive || matched) ? "true" : undefined,
      "data-state": st ?? undefined,
      ...
      style: {
        ...
        ...(palette && !graded && matched ? {
          borderLeft: `10px solid ${linkColor(i)}`
        } : {})
      }
    }, /*#__PURE__*/React.createElement("span", null, pair.left), st === "correct" && /*#__PURE__*/React.createElement(IconCheck, null), st === "wrong" && /*#__PURE__*/React.createElement(IconX, null));
  })), /*#__PURE__*/React.createElement("div", {
    className: "mech-col"
  }, order.map(ri => {
    const label = opts[ri];
    if (label === undefined) return null;
    const linked = rightToLefts[ri] ?? [];
    ...
    return /*#__PURE__*/React.createElement("button", {
      ...
      type: "button",
      ref: el => {
        if (el) rightRefs.current[ri] = el;
      },
      className: "mech-tile",
      onClick: () => tapTile("right", ri),
      disabled: graded,
      "data-selected": !graded && (isActive || isLinked) ? "true" : undefined,
      "data-state": st ?? undefined,
      "data-locked": graded ? "true" : undefined,
      style: {
        display: "flex",
    ...
    }, /*#__PURE__*/React.createElement("span", null, label), palette && !graded && isLinked && /*#__PURE__*/React.createElement("span", {
      style: {
        display: "inline-flex",
        gap: 4
      }
    }, linked.map(li => /*#__PURE__*/React.createElement("span", {
      key: li,
      style: {
        width: 13,
        height: 13,
        borderRadius: 3,
        background: linkColor(li)
      }
    }))), st === "correct" && /*#__PURE__*/React.createElement(IconCheck, null), st === "wrong" && /*#__PURE__*/React.createElement(IconX, null));
...
function solve(config) {
  const opts = rightOptions(config);
  const m = {};
  config.pairs.forEach((p, i) => {
    m[i] = opts.indexOf(p.right);
  });
  return m;
}
...
/* ── рабочий пример ── */
function Example() {
  return /*#__PURE__*/React.createElement(TabletFrame, null, /*#__PURE__*/React.createElement(MatchColumns, {
    config: DEFAULT
  }));
}
...
function CrossingDemo() {
  ...
  return /*#__PURE__*/React.createElement(React.Fragment, null, /*#__PURE__*/React.createElement("div", {
  ...
  }, "\u0421\u043E\u0435\u0434\u0438\u043D\u0438\u0442\u044C \u0432\u0441\u0435 \u0432\u0435\u0440\u043D\u043E"), !fix && /*#__PURE__*/React.createElement("button", {
    className: "btn",
    onClick: () => {
      setM({});
      setGraded(false);
    }
  }, "\u0421\u0431\u0440\u043E\u0441\u0438\u0442\u044C")), /*#__PURE__*/React.createElement(TabletFrame, null, /*#__PURE__*/React.createElement(MatchColumns, {
    key: fix ? "f" : "n",
    config: SIX,
    palette: fix,
    controlled: {
    ...
    className: "demo-note"
  }, fix ? "У каждой связи свой цвет (метка слева и цветной маркер у ответа): линию можно проследить даже сквозь пересечения; для «многие-к-одному» у ответа просто несколько разноцветных маркеров." : "Даже при верном решении 6 пар дают клубок одинаковых синих линий, глазами не разобрать, какой пример к какому ответу идёт."));
}
...
function ManyToOneDemo() {
  ...
  return /*#__PURE__*/React.createElement(React.Fragment, null, /*#__PURE__*/React.createElement("div", {
  ...
  }, "\u041F\u043E\u043A\u0430\u0437\u0430\u0442\u044C \u0432\u0435\u0440\u043D\u043E\u0435 \u0440\u0435\u0448\u0435\u043D\u0438\u0435"), /*#__PURE__*/React.createElement("button", {
    className: "btn",
    onClick: () => {
      setM({});
      setGraded(false);
    ...
    className: "demo-note"
  }, "\u0421\u043F\u0440\u0430\u0432\u0430 \u0432\u0441\u0435\u0433\u043E \u0434\u0432\u0430 \u043E\u0442\u0432\u0435\u0442\u0430 (6 \u0438 10), \u0430 \u0441\u043B\u0435\u0432\u0430 \u0447\u0435\u0442\u044B\u0440\u0435 \u043F\u0440\u0438\u043C\u0435\u0440\u0430: \u043A \u043E\u0434\u043D\u043E\u043C\u0443 \u043E\u0442\u0432\u0435\u0442\u0443 \u0434\u043E\u043B\u0436\u043D\u044B \u0438\u0434\u0442\u0438 \u0434\u0432\u0435 \u0441\u0432\u044F\u0437\u0438. \u0420\u0435\u0431\u0451\u043D\u043E\u043A \u0436\u0434\u0451\u0442 \xAB\u043A\u0430\u0436\u0434\u043E\u043C\u0443 \u0441\u0432\u043E\u0451\xBB \u0438 \u043D\u0435 \u0434\u043E\u0433\u0430\u0434\u044B\u0432\u0430\u0435\u0442\u0441\u044F, \u0447\u0442\u043E \u043E\u0434\u0438\u043D \u043E\u0442\u0432\u0435\u0442 \u0438\u0441\u043F\u043E\u043B\u044C\u0437\u0443\u0435\u0442\u0441\u044F \u0434\u0432\u0430\u0436\u0434\u044B."));
}
...
function UnconnectedDemo() {
  ...
  return /*#__PURE__*/React.createElement(React.Fragment, null, /*#__PURE__*/React.createElement("div", {
  ...
  }, "\u0421\u043E\u0435\u0434\u0438\u043D\u0438\u0442\u044C \u0442\u043E\u043B\u044C\u043A\u043E \u0434\u0432\u0435 \u0438 \u043F\u0440\u043E\u0432\u0435\u0440\u0438\u0442\u044C")), /*#__PURE__*/React.createElement(TabletFrame, null, /*#__PURE__*/React.createElement(MatchColumns, {
    key: fix ? "f" : "n",
    config: FOUR,
    requireAll: fix,
    ...
    className: "demo-note"
  }, fix ? "Несоединённые примеры подсвечены пунктиром, «Проверить» заблокирована, пока не связаны все: нельзя сдать недоделанное." : "Две пары не соединены, но «Проверить» сработала, и несоединённые примеры засчитаны как ошибка, хотя ребёнок их просто не доделал."));
}
const CASES = [{
  tag: "t-tab",
  tagText: "Планшет · вёрстка",
  title: "Линии пересекаются и путаются",
  Demo: CrossingDemo,
  ...
  title: "«Многие-к-одному» неочевидно",
  Demo: ManyToOneDemo,
  ...
  title: "Незавершённые связи засчитываются как «неверно»",
  Demo: UnconnectedDemo,
  problem: "«Проверить» доступна, как только создана хотя бы одна связь. Несоединённые примеры грейдятся как ошибочные, хотя ребёнок их просто не доделал; сигнала «соедини все» нет, и «не доделал» неотличимо от «ошибся».",
  fix: "Доработать: блокировать «Проверить», пока не связаны все примеры, или подсвечивать несоединённые перед проверкой; отличать «не соединено» от «неверно»."
}];
function Cases() {
