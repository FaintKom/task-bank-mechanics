...
function CommutativeDemo() {
  ...
  return /*#__PURE__*/React.createElement(React.Fragment, null, /*#__PURE__*/React.createElement("div", {
    ...
    className: fix ? "on" : "",
    onClick: () => setFix(true)
  }, "\u0440\u0435\u043A\u043E\u043C\u0435\u043D\u0434\u0430\u0446\u0438\u0438 (a\xD7b = b\xD7a)")), /*#__PURE__*/React.createElement("span", {
    className: "mech-label",
    style: {
      fontSize: 13
    }
    ...
    className: "demo-note"
  }, fix ? "Засчитываются обе ориентации: 4×3 принимается при цели 3×4, как и переместительное свойство (g4-30)." : "Цель 3×4. Ребёнок строит 4×3 (то же число клеток, та же площадь), но проверка различает ориентацию и считает это ошибкой, противореча правилу a×b = b×a."));
}
...
const CASES = [{
  ...
  title: "3×4 и 4×3 считаются разными (предложение)",
  Demo: CommutativeDemo,
  problem: "Проверка различает ориентацию: при цели 3×4 ответ 4×3 считается ошибкой, хотя это то же число клеток, та же площадь и то же произведение. Это прямо противоречит переместительному свойству умножения (g4-30), которое дети как раз изучают. Нужно обсудить: считать ли это проблемой или допустимым поведением для части задач.",
